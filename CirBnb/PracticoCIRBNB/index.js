...
const alojamiento1 = new Alojamiento("Hotel en Bs As", 100, Categoria.Hotel);
...
console.log(
  `El precio final de la reserva con otro descuento mas es ${reserva1.precioFinal()}`,
);
...
console.log(
  "los apartamentos filtrados por precio 2000:",
  filtrarPorPrecio(catalogo, 2000),
);
